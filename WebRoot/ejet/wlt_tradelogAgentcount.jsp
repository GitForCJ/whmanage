...
<SCRIPT type=text/javascript>
  ...
  function query()
  {
     jQuery("#queryFrame").attr("src","<%=request.getContextPath()%>/report/tradeLogAgent.do?method=query&"+jQuery("#queryform").serialize());
  }
  
  function exportXls()
  {
   jQuery("#queryFrame").attr("src","<%=request.getContextPath()%>/report/tradeLogAgent.do?method=exportReport&"+jQuery("#queryform").serialize());
  }
</SCRIPT>
</head>
...
<div id="tabbox">
  ...
  <div id="tabs_title">
    <ul class="tabs_wzdh">
      <li style="width: 150%">代理商交易统计</li></ul>
  </div>
</div>
...
<iframe style="width: 96%;height: 90%" src="<%=request.getContextPath()%>/report/tradeLogAgent.do?method=query" scrolling="auto" frameborder="0px" id="queryFrame">
