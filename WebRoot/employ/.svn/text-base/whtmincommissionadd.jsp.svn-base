...
<div class="pass_main">
	<div class="pass_title_1">添加小额佣金</div>
    <div class="pass_list">
    	<ul>
           ...
           <li><strong>交易金额：</strong><span><input name="cm_prod" type="text" /><font color="red" size="3"></font></span></li>
<li><strong>返佣金额：</strong><span><input name="cm_prod1" type="text" /><font color="red" size="3"></font></span></li>
        </ul>
   </div>
