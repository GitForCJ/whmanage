...
<jsp:useBean id="tpbean" scope="session" class="com.wlt.webm.business.bean.TpBean" />
 <%
	 List areaList = prod.getAreaListMoney2();
	 
	 request.setAttribute("arrayList",areaList);
	 
	 List groupsList=tpbean.getJTFKGroups();//获取佣金组名称
...
<html:form  method="post" action="/business/prod.do?method=JfAdd">
<div class="pass_main">
	<div class="pass_title_1">添加交罚佣金</div>
    <div class="pass_list">
    	<ul>
