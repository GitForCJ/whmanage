...
<div class="pass_main">
    <div class="pass_list">
    	<ul>
            ...
            <li><strong>原始交易密码：</strong><span><input id="userpassword" name="userpassword" type="password"/></span></li>
  		  	<li><strong>新交易密码：</strong><span><input id="newpass" name="newpass" type="password"/></span></li>
			<li><strong>确认交易密码：</strong><span><input id="confirmpass" name="confirmpass" type="password"/></span></li>
        </ul>
   </div>
