...
<html:form  method="post" action="/rights/sysuser.do?method=registNext">
...
<div class="pass_main">
    ...
    <div class="pass_list">
    	<ul>
            ...
            <li><strong>用户姓名：</strong><span><input  readonly="readonly" name="userename" type="text" value="${userinfo.userename }"/><font color="red">*</font></span></li>
            <li style="display:none"><strong>角色：</strong><span><input name="user_role" type="hidden" value="${userinfo.user_role }"/>
			${userinfo.role_name }
			</span></li>
            <li><strong>邮箱：</strong><span><input name="usermail" type="text" value="${userinfo.usermail }"/></span></li>
            <li><strong>电话：</strong><span><input name="usertel" type="text" value="${userinfo.usertel }"/></span></li>
...
<!--            </span></li>-->
   ...
   <input type="button" value="提交" id="btnSubmit" onclick="submitForm();" class="field-item_button" />
