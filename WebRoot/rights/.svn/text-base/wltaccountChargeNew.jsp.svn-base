...
<div class="pass_main">
	<div class="pass_title_1">资金提现</div>
    <div class="pass_list">
    	<ul>
            <li><strong>资金账户：</strong><span>${userinfo.accountAmount/1000}元</span></li>
            <li><strong>提现金额：</strong><span><input name="chargeFee" id="chargeFee" type="text"  onkeyup="value=value.replace(/[^\d.]/g,'') "/></span></li>
        </ul>
   </div>
   <div class="field-item_button_m">
   <input type="button" value="提现" id="btnSubmit" onclick="submitForm();" class="field-item_button" />
