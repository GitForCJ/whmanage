...
<thead>
<tr>
<th style="height:25px;border:1px solid #cccccc;">汽车类型</th>
<th style="height:25px;border:1px solid #cccccc;">操作类型</th>
<th style="height:25px;border:1px solid #cccccc;">渠道方式</th>
