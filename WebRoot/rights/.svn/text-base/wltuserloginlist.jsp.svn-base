...
<td><a href="<%=path %>/rights/wltloginuserupdate.jsp?uid=<%=userId %>&uname=${userinfo[0]}">修改</a>|<a href="<%=path %>/rights/wltloginuserdetail.jsp?uid=<%=userId %>&uname=${userinfo[0]}">详细</a></td>
</tr>
</logic:iterate>
</tbody>
<!--
...
-->
<tr>
<td colspan="9"><input class="field-item_button" type="button" value="新增登录账号" onclick="javascript:location.href='<%=path %>/rights/wltloginuseradd.jsp?uid=<%=userId %>'"/><input class="field-item_button" type="button" value="返回" onclick="javascript:history.go(-1);"/></td>
</tr>
</table>
</div>
</body>
