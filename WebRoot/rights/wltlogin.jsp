...
<style type="text/css">
	#ddd a:hover {text-decoration:underline;color:red;}
</style>
...
<div class="login_bg" >
	...
	<div class="login_field">
   		<input type="text" name="username" id="username"  value="用户账号" onfocus="if (value =='用户账号'){value =''}" onblur="if (value ==''){value='用户账号'}"  style="font-size:22px;" />
    </div>
	<div class="login_field">
	...
	<div class="login_field1">
	   <input type="text"  id="check" name="vercode" onpaste="return false" value="" onfocus="if (value ==''){value =''}" onblur="if (value ==''){value=''}"  style="font-size:22px;"/> 
	</div>
	<div class="login_ver">
		<img alt="" src="" onclick="refresh()" id="authImg" style="margin-top:10px;" align="absmiddle"/>
	</div>
...
<input type="text" style="display:none;" name="mac" id="txtMACAddr" value=""/>
<input type="hidden" name="adminflag" value="abc"/>
</html:form>
