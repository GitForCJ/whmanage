...
<html:form  method="post" action="/rights/sysuser.do?method=initMessagePwd">
<div class="pass_main">
	<div class="pass_title_1">初始化用户登录密码和交易密码将已短信方式告知对方</div>
    <div class="pass_list">
    	<ul>
           <li><strong>登录账号：</strong><span><input name="cm_value" type="text" /><font color="red" size="3">*</font></span></li>
        </ul>
		<ul>
           <li><strong>接收手机：</strong><span><input name="re_value" type="text" />选填,将登陆账号作为接收手机发送给对方</li>
        </ul>
   </div>
