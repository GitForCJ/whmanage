...
<jsp:useBean id="role" scope="page" class="com.wlt.webm.rights.bean.SysRole"/>
 <%
 	 ...
 	 String cityid=userSession.getUser_site_city();
 	 String cityname=role.getAreaName(cityid);
	    	...
	    	$("#rootPath").val()+"/rights/sysuser.do?method=checkName",
	      	...
	      	function (data){
	      		if(0 == data){
					...
					action="sysuser.do?method=addOilStation";
					target="_self";
...
<html:form  method="post" action="/rights/sysuser.do?method=addOilStation">
    ...
    <div class="pass_list">
    	<ul>
    		<li><div class="pass_title_1">添加用户</div></li>
   	 		...
   	 		<strong>所属市：</strong>
   	 		<span>
				<%=cityname %><input name="user_site_city" id="user_site_city"  value="<%=cityid %>" readonly="readonly" type="hidden">
            </span>
  		  	</li>
