...
<script language="JavaScript">
	...
	function to_modify(){
	 with(document.forms[0]){
			  ...
			  action="wltrolemenumodify.jsp?roleid="+areacope.value;
			  target="_self";
			  submit();
	  	}
	  }
...
<html:form method="post" action="/rights/sysrole.do">
		<tr class="trcontent">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="tablelist">
  ...
  <tr class="tr1">
    ...
    <td align="center"> <input name="ids" type="checkbox" value="${roleinfo[0]}" onclick="setParentid('${roleinfo[0]}')"></td>
  </tr>
  </logic:iterate>
</table>
<p align="center">
  <input type="hidden" name="areacope" value="${areacope}" />
  <input name="Button" type="button" value="修改" class="onbutton" onClick="to_modify()" />
</p>
</html:form>
</body>
</html:html>