...
<html:form method="post" action="/rights/sysrole.do?method=setModuleRights">
<!-- 部门树开始-->
<table class="tablecontent" width="100%" cellspacing="0" cellpadding="0">
		...
		<table class="tablecontent" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td><img src="../images/tree_minusl.gif" id="MEMU_<%=firstroleinfo[1]%>" class="outline" style="cursor:hand" onclick="myclick(this)"></td>
				<td><input disabled_false onclick="onbox(this)"  id="<%=(String) firstroleinfo[2]%>" type="checkbox" value="<%=(String) firstroleinfo[0]%>"
      name="modules" (String) <%=(String) firstroleinfo[1]%> ></td>	
				<td colspan="2"><a href="javascript:myclick(document.all.MEMU_<%=firstroleinfo[1]%>)">&nbsp;<%=firstroleinfo[1].toString()%></a></td>
			</tr>
		</table>
		<table class="tablecontent" border="0" cellspacing="0" cellpadding="0" id="MEMU_<%=firstroleinfo[1]%>d">
					<tr>
				<td>
				<%
      ...
      name="modules" <%=(String) secondroleinfo[1]%> ></td>	
				<td colspan="2">&nbsp;<%=(String) secondroleinfo[1]%></td>
			</tr>
		</table>
			<%
				}
