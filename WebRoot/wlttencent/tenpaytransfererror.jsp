...
<html>
	...
	<body rightmargin="0" leftmargin="0" topmargin="0">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td width="125" background="../images/menu0.on.bg.gif" nowrap>
					<div align="center">
						<a href="tepay.jsp" class="fontmenu">财付通转账</a>
					</div>
				</td>
				<td width="11">
		...
		<form action="tenpaytransfer.jsp" method="get" name="directFrm"
						...
						<table width="100%" border="0" align="center" class="tablecontent">
							<tr>
								<td width="50%" align="center">
									&nbsp;&nbsp;<img src="../images/commonTip.gif" width="25" height="25"/>&nbsp;&nbsp;<font color="#FF0000">您通过财付通的转账失败!</font>
								</td>
							</tr>
						</table>
					</td>
			...
			<p align="center">
				<input type="button" name="continue" value="关闭" class="onbutton" onclick="window.close();">
			</p>
			<br><br><br>
			<p align="center">
