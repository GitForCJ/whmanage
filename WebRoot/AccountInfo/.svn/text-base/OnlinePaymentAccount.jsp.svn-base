...
<script type="text/javascript">
	function funA(requestUrl)
	{
		...
		// 关闭弹出层后的 ifream 页面路径
		window.parent.document.getElementById("responseUrl").value="<%=path%>/AccountInfo/OnlinePayment.jsp";
	}
</script>
</head>
...
<thead>
<tr>
<th>确定转帐信息&nbsp;<a href="<%=path%>/AccountInfo/OnlinePayment.jsp">返回上一步</a></th>
</tr>
</thead>
<tbody>
<tr>
<td  style="padding-left:40px;"><div class="tab1">产品类型：深圳市万恒科技额度购买</div>
<div class="tab1">转账方式：<img src="<%=path%>/images/bank.jpg" style="border:1px solid #cccccc;"/></div>
<div class="tab1">转账金额：${moeny} 元</div>
<div class="tab1"><span class="btn3"><a href="${requestUrl}" onclick="funA('${requestUrl}')" target="_blank">点击确定使用在线支付转账</a></span></div>
</td>
