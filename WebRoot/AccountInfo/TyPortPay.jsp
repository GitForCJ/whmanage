...
<form action="<%=path%>/business/bank.do?method=tyPortPay" method="post" name="directFrm" onSubmit="return payFrm();">
        <fieldset>
               <div class="pass_list" style="margin-left: 150">
   	  <ul>
            <li style="font-size: 12px;"><strong  style="margin-top:10px;">转款方式：</strong><span><img src="<%=path%>/images/yizhifu.jpg" style="border:1px solid #cccccc;width:170px;height:45px;"/></span></li>
...
<li style="list-style:none;">2、支持通过银行网银、第三方支付购买额度。</li><!-- ，手续费为转款金额的千分之二。 -->
<li style="list-style:none;">&nbsp;</li>
<li style="list-style:none;">3、交易额度最低10元，手续费为转款金额的千分之二。</li>
<li style="list-style:none;">&nbsp;</li>
<li style="list-style:none;">4、银行网银及第三方支付支持部分信用卡，详情请查看“帮助中心”账户充值。</li>
<li style="list-style:none;">&nbsp;</li>
</ul>
</div>
</body>
