...
function pcprint(){
  if(document.form1.printtype[0].checked)
  {
    document.printInvoice.print();
     document.URL = '../operation/mobiletransact.jsp';
    return ;
...
String service = "移动业务办理";
     
Vector detailPrint = new Vector ();
detailPrint.add("业务类型：");	 
detailPrint.add("移动业务办理");

detailPrint.add("交易终端：");
detailPrint.add(te_id);

detailPrint.add("套餐类别：");
detailPrint.add(typeName); 

detailPrint.add("套餐名称：");
...
detailPrint.add("扣款金额：");
detailPrint.add(charge);
...
detailPrint.add("备注：");
detailPrint.add(remart+"//,办理身份证//,办理身份证");
...
<table width="810" border="0" align="center">
  ...
  <tr>
    <td width="320" height="29" align="left">业务类别</td>
    <td align="left"><%=typeName%></td>
  </tr>
  <tr>
    <td width="320" height="29" align="left">代办业务</td>
