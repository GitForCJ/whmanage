...
function pcprint(){
	if(document.form1.printtype[0].checked)
	{
	  ...
	  document.URL = '../operation/phonepay3.jsp';
	  return ;
...
<p align="center" class="STYLE2"><u>中国电信股份有限公司广东分公司收费专用发票</u></p>
...
name="printInvoice" width="0" height="0" hspace="0" vspace="0" align="middle" id="printInvoice" >
    <param name="userName" value="<%="客户姓名："+userName%>"></param>
	<param name="phone" value="<%="客户号码:"+phone%>"></param>
	...
	<param name="payDate" value="<%="计费周期："+payDate%>"></param>
	<param name="terminal" value="<%=te_id%>"></param>
	<param name="itemName" value="<%=itemName%>"></param>
    <param name="itemCoor" value="<%=itemCoor%>"></param>
	<param name="year" value="<%=year+"年"%>"></param>
	<param name="month" value="<%=month+"月"%>"></param>
	<param name="date" value="<%=date+"日"%>"></param>
...
name="printInvoice1" width="0" height="0" hspace="0" vspace="0" align="middle" id="printInvoice1" >
	<param name="detailNumber" value="<%=detailNumber*2%>"></param>
	<param name="tradetype" value="<%="电信缴费"%>"></param>
	<param name="terminal" value="<%=te_id%>"></param>
