...
<body topmargin="0" leftmargin="0" rightmargin="0">
	<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="menu_table">
		<tr> 
			...
			<td width="125" background="../images/menu0.on.bg.gif" nowrap> <div align="center" ><a href="banktransferquery.jsp" class="fontmenu">银行转账查询</a></div></td>
...
<form method="post" action="../common/loadcount.jsp">
	<input type="hidden" name="url" value="../common/count.do?beanName=com.commsoft.epay.pc.count.bean.UnionpaylogCount">
	...
	<table width="80%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableoutline">
	    <tr class="trcontent">  
	      	<td colspan="4" align="center" class="fontcontitle">&nbsp;银行转账查询&nbsp;</td>
	    </tr>
	    <tr>
	    	<td>
	    		<table width="100%" border="0" align="center" class="tablecontent">
	    			<tr>
		          	<td>统一支付账号</td>
		            	<td width="50%">
		            	   <input name="fundacct" size="15" class="inputdistinct">
			            </td>
		          	</tr>
		          	<tr>
		          	<td>银行账号</td>
		            	<td width="50%">
		            	   <input name="tradeObject" size="19" class="inputdistinct">
			            </td>
		          	</tr>
		          	<tr>
		          	<td>转账流水号</td>
		            	<td width="50%">
		            	   <input name="tradeSerial" size="30" class="inputdistinct">
			            </td>
		          	</tr>
		          	<tr>
		          	<td>交易状态</td>
