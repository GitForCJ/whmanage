...
$(function(){
	...
	with(document.forms[0]){
		if(confirm("确认为号码："+ tradeObject.value+" 缴费："+$("#js_id_money_show").text()+"元")){
          ...
          $("#btnBak").hide();
          $("#bfBox").show();
          document.forms[0].action="../business/mobileCharge.do?method=tzFill&tztype=01012&money="+$("#js_id_money_show").text();
          submit(); 
      }
      }
	}
        ...
        <fieldset>
          <div class="form-line" name="dv1">
            ...
            <div class="element clearfix">
             <div class="mobile-num"><input type="text" id="js_id_mobile" name="tradeObject" style="font-family:'宋体'; font-size:26px; font-weight:bold;"></div>
          ...
          <div class="form-line high-text charge-money" name="dv1">
            ...
            <div class="element">
              <div id="js_id_price">
                  ...
                  <a class="charge-money-sum on" data-value='30' href="javascript:void(0);" hidefocus="true" data-money="30" data-lidou='30' data-vip='0' data-grow='50'><span>30元</span></a>
...
<div class="field-item_button_m" id="bfBox" style="display:none"><div class="bufferBox">
    ...
    <font style="font-family:'宋体'; font-size:17px; " color="red">欢迎使用全国充值业务，针对全国电信、移动、联通手机用户，选择面额进行手机充值，充值后无法进行冲正，请谨慎操作</font>
</body>
