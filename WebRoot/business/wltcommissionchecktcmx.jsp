...
String path = request.getContextPath();
  ...
  List list = commission.listCommissiontcmx(sg_id); 
...
<script language="JavaScript">
	function ha_addtcmx(){
	 with(document.forms[0]){
	  action="wltcommissiontcmxadd.jsp?sg_id="+sg_id.value;
	  target="_self";
	  submit();
	  }
	}
	...
	function ha_delmx(){
	  with(document.forms[0]){
	  		if(hasRole() && isSelectRole()){
			  	action = "syscommission.do?method=delmx";
			  	target="_self";
			  	submit();
	  		}
	  }
...
<p align="center">
  ...
  <input name="Button" type="button" value="增加" class="onbutton" onClick="ha_addtcmx()">
  <input type="button" name="Submit2" value="删除" class="onbutton" onClick="ha_delmx()">
  <input name="Button" type="button" value="返回" class="onbutton" onClick="location.href='<%=path %>/business/wltcommissiontclist.jsp'">
</p>
</html:form>
</body>
</html:html>