...
function checksubmit(){
	...
	$("#form1").first();
	$("#form1").attr("action","<c:url value='/business/order.do?method=listin'/>");
	$("#form1").submit();//提交
...
function excelExport(){
	...
	$("#form1").first();
	$("#form1").attr("action","<c:url value='/business/order.do?method=inExcelExport'/>");
	$("#form1").submit();//提交
...
<form id="form1" action="<%=path %>/business/order.do?method=listin" method="post">
<div class="header">
	...
	<nobr>
		<ul><!-- 
		  ...
		  <li>
		  <div class="sub-input"><a class="sia-2 selhover" id="sl-service" href="javascript:void(0);">交易类型</a></div>
...
<td class="td_line">${ordinfo[2]/1000.0}</td>
