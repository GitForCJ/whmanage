...
<input type="text" id="js_id_mobile" name="tradeObject" style="font-family:'宋体'; font-size:26px;width:220px; font-weight:bold;" maxlength="13" value="${ph }"/>
...
<td>${rvinfo[2]}</td>
<td>${rvinfo[3]}</td>
<td><input name="ids" type="checkbox" value="${rvinfo[4]}#${rvinfo[5]}" /></td>
</tr>
</logic:iterate>
</tbody>
</table>
...
<div class="field-item_button_m" style="margin-left: 100px;" id="btnChag"><input type="button" name="Button" value="冲正" class="field-item_button" onclick="check(1);" id="xx" /></div>
 ...
 <font style="font-family:'宋体'; font-size:13px;margin-left: 20px;" color="#333333;">仅支持“全国充值”菜单发起的广东移动、广东联通和“广东电信”菜单发起的充值进行冲正，广东电信预付费号码24小时内冲正有效，后付费号码6小时有效，广东移动和联通号码24小时内有效。冲正操作受多种条件限制，不承诺一定成功。</font>
</body>
</html>
