...
<form action="<%=path %>/rights/sysuser.do?method=dengluMsgValidata" id="form1" method="post" class="form">
        <fieldset>
          <div class="form-line">
<br>
<br>
<br>
            <label class="label" for="mobile-num"><font size="3" color="red">用户登陆短信验证：</font></label>
<hr>         
<br>  
...
<br>
<br>
获取短信验证码手机号码为:<span>${requestScope.phonenum}</span>   
<br>  
<br> 
</div>
          </div>
