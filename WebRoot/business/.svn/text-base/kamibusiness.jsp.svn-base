...
$(function(){
	...
	function check(){ 
	var array=["133","153","181","180","189","186"];
	...
	with(document.forms[0]){
		if(confirm("确认为号码："+ tradeObject.value+" 缴费："+js_id_money_show.innerText+"元")){
          ...
          $("#btnBak").hide();
          $("#bfBox").show();
          document.forms[0].action="../kami/fill.do?method=kmFill&money="+js_id_money_show.innerText+"&pArea="+pArea.innerText;
          submit(); 
      }
      }
	}
...
<div class="field-item_button_m" id="bfBox" style="display:none"><div class="bufferBox">
    ...
    <font style="font-family:'宋体'; font-size:17px; " color="red">欢迎使用电信卡密充值业务，针对全国电信手机用户，选择面额进行手机充值，充值后无法进行冲正，请谨慎操作</font>
</body>
