...
<div class="pass_main">
	<div class="pass_title_1">添加用户接口</div>
    <div class="pass_list">
    	<ul>
			...
			<input name="charge_type" id="charge_type" defaultsel="请选择[]|所有业务[0]|移动[1]|联通[2]|电信[3]" type="hidden" value="" />
			</span></li>
			...
			<input name="is_return" id="is_return" defaultsel="请选择[]|是[0]|否[1]" type="hidden" value="" />
			</span></li>
        </ul>
   </div>
