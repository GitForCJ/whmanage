...
$(function(){
	...
	function check(){ 
	var array=["130","131","132","155","156","185","186","145"];
	...
	with(document.forms[0]){
		if(confirm("确认为号码："+ tradeObject.value+" 缴费："+js_id_money_show.innerText+"元")){
          ...
          $("#btnBak").hide();
          $("#bfBox").show();
          document.forms[0].action="../xunjie/xjaction.do?method=xjCharge&xjtype=1&money="+js_id_money_show.innerText;
          submit(); 
      }
      }
	}
...
<div class="field-item_button_m" id="bfBox" style="display:none"><div class="bufferBox">
    ...
    <font style="font-family:'宋体'; font-size:17px; " color="red">欢迎使用湖北联通充值，充值后无法进行冲正，请谨慎操作</font>
</body>
