...
function checksubmit(){
	...
	$("#form1").first();
	$("#form1").attr("action","<c:url value='/business/order.do?method=listuser'/>");
	$("#form1").submit();//提交
	funLoad();
}
function funLoad()
...
function excelExport(){
	...
	$("#form1").first();
	$("#form1").attr("action","<c:url value='/business/order.do?method=userExcelExport'/>");
	$("#form1").submit();//提交
...
<form id="form1" action="<%=path %>/business/order.do?method=listuser" method="post">
<div class="header">
...
<div class="grayr">
<wlt:pager url="business/order.do?method=listuser${requestScope.order.paramUrl}" page="${requestScope.page}" style="black" />
</div>
</td>
<!--
<td colspan="8">
