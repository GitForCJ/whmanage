...
<%
  List list = commission.listCommissionsgroup(); 
...
<script language="JavaScript">
	function ha_add(){
	 with(document.forms[0]){
	  action="wltcommissionadd.jsp?stype=3";
	  target="_self";
	  submit();
	  }
	}
	...
	document.forms[0].areacope.value=areavalue;	
		...
		function ha_modify(){
	 	...
	 	var count = checkedSize(ids);
	 	 ...
	 	 action="wltcommissionmodify.jsp?stype=3&sg_id="+areacope.value;
	  	target="_self";
	  	submit();
	 	 }
	 	 }
	 	...
	 	var count = checkedSize(ids);
	 	 ...
	 	 action="wltcommissionchecksmx.jsp?sg_id="+areacope.value;
	  	target="_self";
	  	submit();
	 	 }
	 	 }
...
<html:form method="post" action="/business/syscommission.do?method=del">
		<tr class="trcontent">
		<td colspan="4" align="center" class="fontcontitle">&nbsp;代理商提成佣金组信息&nbsp;</td>
		</tr>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="tablelist">
  <tr class="trlist">
    <td colspan="9"><div align="center" class="fontlisttitle">代理商提成佣金组</div></td>
  </tr>
