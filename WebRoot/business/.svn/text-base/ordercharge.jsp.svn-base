...
<div class="pass_main">
    ...
    <div class="pass_list">
    	<ul>
            <li><strong>充值号码：</strong><span>${param.v1}</span></li>
            <li><strong>充值金额：</strong><span>${param.v2/100}</span><span>元</span></li>
            <li><strong>充值接口商：</strong><span>${param.v3 }</span></li>
            <li><strong>业务类型：</strong><span>${param.v4}</span></li>
            <li><strong>号码类型：</strong><span>${param.v5}</span></li>
        </ul>
   </div>
