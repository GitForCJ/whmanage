...
String path = request.getContextPath();
  ...
  List list = commission.listCommissionsmx(sg_id); 
...
<script language="JavaScript">
	function ha_addsmx(){
	 with(document.forms[0]){
	  action="wltcommissionsmxadd.jsp?sg_id="+sg_id.value;
	  target="_self";
	  submit();
	  }
	}
...
<p align="center">
  ...
  <input name="Button" type="button" value="增加" class="onbutton" onClick="ha_addsmx()">
  <input type="button" name="Submit2" value="删除" class="onbutton" onClick="ha_delmx()">
  <input name="Button" type="button" value="返回" class="onbutton" onClick="location.href='<%=path %>/business/wltcommissionslist.jsp'">
</p>
</html:form>
</body>
</html:html>