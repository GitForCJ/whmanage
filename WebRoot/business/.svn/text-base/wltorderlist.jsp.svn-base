...
<tr><td colspan="8" align="left">当前页,交易总额：${requestScope.curTotal/1000.0 }&nbsp;&nbsp;面值总额：${requestScope.valueTotal/1000.0 }</td></tr>
<tr><td colspan="8" align="left">
	总计,交易总额：<fmt:formatNumber value="${requestScope.totalFee[1]/1000.0}" pattern="#0.000"/>&nbsp;&nbsp;
	面值总额：<fmt:formatNumber value="${requestScope.totalFee[0]/1000.0}" pattern="#0.000"/>&nbsp;&nbsp;
	交易笔数：${requestScope.totalFee[2]}
	</td>
</tr>
</tbody>
<tfoot>
