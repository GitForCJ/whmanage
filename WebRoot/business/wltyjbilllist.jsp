...
function checksubmit(){
	...
	$("#form1").first();
	$("#form1").attr("action","<c:url value='/business/acctbill.do?method=yjList'/>");
	$("#form1").submit();//提交
...
function excelExport(){
	...
	$("#form1").first();
	$("#form1").attr("action","<c:url value='/business/acctbill.do?method=excelExportYjList'/>");
	$("#form1").submit();//提交
...
<form id="form1" name="form1" action="<%=path %>/business/acctbill.do?method=yjList" method="post">
<div class="header">
...
<td class="td_line">${ordinfo[6]}
<c:if test="${ordinfo[6] == ''}">-</c:if></td>
</tr>
</logic:iterate>
...
<div class="grayr">
<wlt:pager url="business/acctbill.do?method=yjList${requestScope.acctbill.paramUrl}" page="${requestScope.page}" style="black" />
</div>
</td>
</tr>
</tfoot>
