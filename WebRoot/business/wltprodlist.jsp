...
<%
  ...
  List list = biProd.listvalueRange(); 
...
<html:form method="post" action="/business/prod.do?method=del">
		<tr class="trcontent">
		<td colspan="4" align="center" class="fontcontitle">&nbsp;面额区间信息&nbsp;</td>
		</tr>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="tablelist">
  <tr class="trlist">
    <td colspan="9"><div align="center" class="fontlisttitle">面额区间信息</div></td>
  </tr>
  <tr class="fontcoltitle">
    <td nowrap="nowrap"><div align="center" >序号</div></td>
    <td nowrap="nowrap"><div align="center" >产品编号</div></td>
    <td nowrap="nowrap"><div align="center" >面额最小值</div></td>
    <td nowrap="nowrap"><div align="center" >面额最大值</div></td>
  ...
  <tr class="tr1">
    ...
    <td align="center">${prodinfo[0]}</td>
<td align="center">${prodinfo[1]}</td>
<td align="center">${prodinfo[2]}</td>
