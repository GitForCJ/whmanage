	  ...
	  with(document.forms[0]){
	  		if(isSelectRole()){
				...
				if(count>1){
			  	...
			  	action = "prod.do?method=delawards";
			  	target="_self";
			  	submit();
	  		}
	  }
...
<html:form method="post" action="/business/prod.do?method=del">
		<tr class="trcontent">
		<td colspan="4" align="center" class="fontcontitle">&nbsp;<B>月度奖励规则</B>&nbsp;</td>
		</tr>
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="tablelist">
  <tr class="trlist">
    <td colspan="9"><div align="center" class="fontlisttitle">月度奖励规则</div></td>
  </tr>
  <tr class="fontcoltitle">
    <td nowrap="nowrap"><div align="center" >序号</div></td>
    <td nowrap="nowrap"><div align="center" >规则编号</div></td>
    <td nowrap="nowrap"><div align="center" >用户类型</div></td>
  ...
  <logic:iterate id="awardsList" name="awards" indexId="i">
  <tr class="tr1">
    <td align="center">${i + 1}</td>
    <td align="center">${awardsList[0]}</td>
<c:if test="${awardsList[1]==2}">
<td align="center">代理商</td>
</c:if>
<c:if test="${awardsList[1]==4}">
<td align="center">接口商</td>
</c:if>
<td align="center">${awardsList[2]}</td>
<td align="center">${awardsList[3]}</td>
<td align="center">${awardsList[4]}%</td>
    <td align="center"> <input name="ids" type="checkbox" value="${awardsList[0]}"></td>
  </tr>
  </logic:iterate>
</table>
<p align="center">
