...
<script language="JavaScript">
	function ha_addmx(){
	 with(document.forms[0]){
	  action="wltcommissionmxadd.jsp?sg_id="+sg_id.value;
	  target="_self";
	  submit();
	  }
	}
...
<p align="center">
  ...
  <input name="Button" type="button" value="返回" class="onbutton" onClick="location.href='<%=path %>/business/wltcommissionlist.jsp'">
</p>
</html:form>
</body>
</html:html>