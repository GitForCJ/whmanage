...
function check(){
	...
	if(parseInt(_startFee) > parseInt(_endFee)){
  	...
  	with(document.forms[0]){
		action="syscommission.do?method=addtcmx";
		target="_self";
		submit();
	}
}
...
<div class="pass_main">
    ...
    <div class="pass_list">
        <ul>
   	 		...
   	 		<strong>级别：</strong>
   	 		<span>
   	 			<div class="sub-input"><a class="sia-2 selhover" id="sl-sc_level" href="javascript:void(0);">请选择</a></div>
				<input name="sc_level" id="sc_level" defaultsel="请选择[]|一级[2]" type="hidden" value="" />
			</span>
  		  	</tr>
  		  	</li>
