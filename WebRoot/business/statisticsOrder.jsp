...
showMessage("${mess}");
	...
	function checksubmit()
	{
		...
		document.getElementById("form1").action="<%=path %>/business/acctbill.do?method=statisticsOrderList&subtype=0";
	...
	//	alert(ahidden.value.Trim());
		...
		document.getElementById("form1").action="<%=path %>/business/acctbill.do?method=statisticsOrderList&subtype=1";
		document.getElementById("form1").submit();
		return;
	}
