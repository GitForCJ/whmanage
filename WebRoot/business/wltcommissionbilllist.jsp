...
function checksubmit(){
	...
	$("#form1").first();
	$("#form1").attr("action","<c:url value='/business/acctbill.do?method=commList'/>");
	$("#form1").submit();//提交
...
function excelExport(){
	...
	$("#form1").first();
	$("#form1").attr("action","<c:url value='/business/acctbill.do?method=excelExportCommList'/>");
	$("#form1").submit();//提交
...
<form id="form1" name="form1" action="<%=path %>/business/acctbill.do?method=commList" method="post">
<div class="header">
...
<td class="td_line">${ordinfo[9]/100}</td>
</tr>
</logic:iterate>
<tr><td colspan="8">&nbsp;</td></tr>
<tr><td colspan="8" align="left">当前页实际交易总额：${requestScope.curTotal/100 }</td></tr>
<tr><td colspan="8" align="left">实际交易总额总额：${requestScope.totalFee/100 }&nbsp;交易笔数:${requestScope.totalCount }</td></tr>
</tbody>
<tfoot>
<tr height="30">
