...
public class dingxFlow {
	 ...
	 * @param times
	 *            yyyyMMddhhmmss
	 * @return 0成功 -1 失败 2处理中
	 */
	public static String fillFlow(String orderid, String account, String gprs,
		...
		if (null != str) {
			...
			if("0".equals(rs.getError())){//正常
			if("2".equals(rs.getState())){
				n=-1;
			}else if("1".equals(rs.getState())||"3".equals(rs.getState())){
				n=0;
			}
			}else if(!"1007".equals(rs.getError())&&!"9999".equals(rs.getError())){
				n=-1;
			}
		}
		return n+"";
