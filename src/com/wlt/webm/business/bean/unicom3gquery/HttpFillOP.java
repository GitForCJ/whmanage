...
public class HttpFillOP {
    ...
    public static String flow18="43";//昊峰 联通
    
    public static String FLOW19="44";//鼎信电信
    public static String FLOW20="45";//鼎信移动
    public static String FLOW21="46";//鼎信联通
    public static String FLOW22="47";//智信联通
    public static String FLOW23="48";//智信电信
    
    public static String FLOW24="49";//昊峰电信
    public static String FLOW25="50";//昊峰移动
			...
			if(!"".equals(aa)){
				...
				for(String[] s:ar){
					...
					try {
						...
						Log.info("流量同步产品,号码:"+phone+",,计算佣金错误"+e.toString());
						return null;
					}
...
//		 }
	...
	public static String queryResultZDJSON(String orderNo) {
		...
		try {
			db=new DBService();
			String[] strs=db.getStringArray("SELECT state,CONCAT(writeoff,'流量充值'),writeoff,tradetime,chgtime,tradefee AS cc FROM "+tableName+" WHERE tradeserial='"+orderNo+"'");
			if(strs==null || strs.length<=0){
				//订单不存在
				rs="{\"desc\":\"查询失败，无该订单\",\"status\":\"2\"";
			}else if("0".equals(strs[0])){
